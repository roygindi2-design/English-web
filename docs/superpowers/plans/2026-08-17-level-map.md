...
- [ ] **Step 1: כתוב את בדיקת השומר, לפני ה-SQL**
...
- [ ] **Step 2: הרץ את הבדיקה וּודא שהיא נכשלת מהסיבה הנכונה**
...
- [ ] **Step 4: הרץ את שתי הבדיקות והוכח מעבר**
...
- [ ] **Step 5: מוטציה אחת שמוכיחה שהשומר חי**
