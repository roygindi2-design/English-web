...
export default function ArenaStage({
  ...
  return (
    ...
    >
      ...
      {/* 🧍 **⟦`C-0783` · `T-456`⟧ מעוגן ב**רגליים** (`bottom-[46%]` ⇒ רגליים ב-54%,
          ‏`HORIZON + 8`, בלב הטבעת של `T-454`), ⛔ ולא בראש.** 🔬 נמדד ב-393×852:
          ‏`top-[16%]` הושיב את הרגליים ב-45% — **מעל** הקו, על שורת הלבנים — כי גובה
          החריץ קבוע (96px) ⇒ ככל שהבמה גבוהה יותר, הרגליים עלו. ⇒ העוגן הוא מה שנוגע ברצפה. */}
      <div data-arena-slot="enemy" className="absolute inset-x-0 bottom-[46%] flex flex-col items-center">
