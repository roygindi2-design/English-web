...
const FIG = {
  ...
  gold: 'text-[color:var(--arena-fig-trim,currentColor)]',
  goldLight: 'text-[color:var(--arena-fig-trim-lit,currentColor)]',
  ...
  cast: 'text-[color:var(--arena-fig-robe,currentColor)]',
