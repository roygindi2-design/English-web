    ...
    <div aria-busy="true" aria-live="polite" className="flex flex-1 flex-col">
      ...
      <div className="flex flex-1 flex-col gap-4">
        ...
        <div className="space-y-2">
          <div className="h-5 w-full rounded-2xl bg-border-subtle" />
          <div className="h-5 w-2/3 rounded-2xl bg-border-subtle" />
        </div>
      </div>

      <div className="min-h-touch rounded-2xl bg-border-subtle py-3" />
    </div>
  );
}
