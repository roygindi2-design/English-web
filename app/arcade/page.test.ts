...
const ARENA_HEXES = ['#d4a94a', '#f5d684', '#4a4858', '#34323f', '#1c2642',
                     /* ⟦T-427 · `D-282`⟧ `#b478f0` · `#ff7878` · `#96e6ff` יצאו — מבטאי הזירה
                        הוחלפו ב-`--brand`/`--danger` של `palette.ts`. `#d4a94a` · `#f5d684` ·
                        `#c482ff` נשארו כצבעי תלבושת (`--arena-fig-*`). */
                     '#c482ff',
                     ...
                     '#c1465f', '#8c2f42',
                     /* 🥋 `C-0755` · `T-444` — הנווד. 🔬 נמדדו מול `--arena-card`
                        (`#182138`), ⛔ ולא הונחו: `7.01:1` ו-`4.00:1`, שניהם מעל
                        הסף `3:1` ש-`check:mobile` מודד בתוך `<button>`. */
                     '#d9a15c', '#a9743c'] as const;
