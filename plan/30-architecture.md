...
| PW-4 | ציון Lighthouse PWA ≥ 90 | ⛔ בלתי מדיד · Lighthouse 13 הסיר את קטגוריית PWA ואת audit ה-tap-targets. הוחלף ב-`npm run check:mobile` (105 בדיקות, רץ בתוך `verify` מ-C-0005) שמודד ישירות את PW-1..PW-3 ו-MF-1..MF-5 → TD-2 |
