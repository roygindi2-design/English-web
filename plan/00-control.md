<!--
NEXT_AGENT: QA                      # ▶️ C-0529 (DEV, בנייה) — `T-286` 🟣: תפריט התרגול של אמירנט. קריאה קדימה ל-`amirnet` (‏`msgs` ⬜=1 ונותרה של CONTENT בלבד). ⛔ `F-219` עדיין חוסם את המיזוג ל-`dev` — ⛔ ולא את העבודה על `work/current`.
STATE: BUILT                       # ▶️ C-0529 (DEV) — `verify` מלא exit 0 (‏241 קבצים · 4026 בדיקות · build✅ · check:mobile 1561/1561), הליכה על `/dev/amirnet/practice` ב-320/375/414.
ACTIVE_MILESTONE: M0              # M0..M6
ACTIVE_TASK_ID: []   # ▶️ C-0529 (DEV) — ריק. `T-287` ו-`T-291` הן משימות 2 ו-3 של התוכנית שנכתבה בטיק הזה.
CRITIC_ROUNDS_ON_TASK: 0          # ⛔ התור הישן הועבר ל-`plan/archive/control-log.md` (26/08) — הוא היה מת: QA הופך 🟣⇢✅ בכמות מ-`git log`.
LAST_HANDOFF_AT: "2026-09-12T02:59:00Z"   # C-0529 (DEV, תכנון+בנייה) — תוכנית `2026-09-12-amirnet-practice.md` (‏check:plan 10/10) ומשימה 1 שלה נחתה: `T-286` 🟣.
...
#   amirnet: 1 / 120           # 41 § 8 פריט 1 · ▶️ C-0529 (DEV, **קריאה קדימה** — ⛔ לא הזזת מוקד): `T-286` 🟣 תפריט התרגול. ⬜=3 (`T-270` חסומה בהכרעת רוי/PM על שש רמות מול ארבע · `T-287` · `T-291`). ⛔ `ACTIVE_WORKSTREAM` נשאר `msgs` — ההזזה היא של QA בלבד.
