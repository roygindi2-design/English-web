...
LOCK_HELD_BY: "CONTENT"               # 🔒 נעילה — טיק CONTENT מתוזמן (45 3,9,15,21 * * * UTC), אצווה שגרתית Tier 1.
LOCK_AT: "2026-09-16T15:59:00Z"
...
#   cards:  17 / 120           # § 13-3 · **המוקד.** ⬜=**4** (`T-390`·`T-393`·`T-394`·`T-395`) · 🟣=5 (`T-325` חלקית·`T-388`·`T-389`·`T-391`·`T-392`). ⛔ אינה חתומה. הנרטיב ⇒ `plan/61-deferred.md`
...
WORKSTREAM_ENDING: "cards · 4 ⬜ נותרו · 2026-09-16T15:10:00Z · C-0659"   # 🟡 **עודכן `C-0659` (PM) — ספירה, ⛔ ולא הכרזה.** היה 1, ו-4 שורות נפתחו בטיק הזה ⇒ ⛔ **⛔ אינו עצירה** ו⛔ אינו רשות להזיז את המוקד: ⬜>0 ⇒ `§ 0.23 ז׳` ③ אומר «הישאר».
...
| C-0661 | CONTENT | QA (ללא שינוי ב-`NEXT_AGENT`) | 2026-09-16T16:10:00Z | 📚 **אצוות רקע — 25 מילים Tier 1 אמירנט (`predict`…`quietly`), K-005/K-007.** שער אמיתי 25/25 (סבב שני), 0 `low`. `T-353` עדיין ⬜ (נבדק חי לפני בחירת האצווה) ⇒ נכתב עם המנגנון המלא, ⛔ לא בקיצור-הנפח שרוי ביקש 14/09. כיסוי: 931→956/3,382 (Tier 1+2). הליכה חיה 375×780 (`next start -p 3200`): כרטיסי הפיקסטורה (`/dev/card`·`/dev/card/choice`·`/dev/card/typed`·`/dev/deck`) הם `Lorem`/`Ipsum` מוצהרים — לא תוכן אמיתי; הכרטיס האמיתי בעמוד הבית (`again`/שוב) קרא נכון ב-RTL, 0 פגם. פסילת-סבב-ראשון חוזרת (11/25) — אותו דפוס כמו לקחים 49·51·52, תועד כלקח 53, ⛔ אין תוספת חדשה ל-§ א׳1. | `data/generated/batch-2026-09-16-3.jsonl` · `manifest-2026-09-16-3.json` · `plan/80-content-lessons.md` |
