...
NEXT_AGENT: PM                    # ▶️ מפרט העוגן נכתב: plan/36-video-spec.md + plan/37-arena-spec.md. ה-PM קורא אותם ראשון, גוזר מהם משימות לפי סדר סעיף 13, ומעדכן 50-tasks. ⚠️ ארבע המשימות המתוזמנות עדיין כבויות — הדלקתן היא החלטת רוי.
