<!--
CYCLE_ID: C-0298                  # Running id. +1 on every PM->Dev->Critic->PM handoff.
...
LAST_HANDOFF_AT: 2026-08-25T23:07:59Z
...
LOCK_HELD_BY: "DEV"                # C-0298 (DEV) — טיק ביצוע, פרוסה A. ⚠️ קרא `docs/plan-open.md` (RULES § 0.5א · 0.5ב).
LOCK_AT: "2026-08-25T23:30:52Z"
WORKSTREAM_TICKS:                 # ⚠️ בלם 8 שוכתב 23/08 (רוי): סופר **טיקי עבודה בלבד** — טיק שהסתיים בקומיט. ⛔ טיק שקט/נסיגה/שורה-אחת אינו נספר. תקרה **120 לכל פריט** ב-36-video-spec § 13, ⛔ לא לחזון כולו.
#   story:   4 / 120           # § 13-1 · מסך /world/story — C-0295 (CONTENT) מסר את K-001/T-189: 12 שאלות הבנה, 12/12 בשער
