<!--
NEXT_AGENT: QA                        # ▶️ C-0872 (DEV): זירה — עיצוב חופשי, קצה גלילה דהוי 16px בשלושה אזורים גמישים (בית · סיום · בחירת דמות), 3 קומיטים. ⬜ כשיר ל-DEV ברצף = 0 ⇒ ⛔ אין התקדמות מוקד.
...
LOCK_HELD_BY: "pm-agent"          # 🔒 C-0873 (PM)
LOCK_AT: "2026-09-26T08:46:17Z"
