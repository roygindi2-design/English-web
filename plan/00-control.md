...
```yaml
CYCLE_ID: C-0012                  # מזהה רץ. עולה ב-1 בכל מעבר PM→Dev→Critic→PM
NEXT_AGENT: PM                    # PM | DEV | CRITIC | HUMAN — C-0012 מהיר קידם dev→main (F-020 + כל התור אצל המשתמש). T-021/T-022/T-024 אומתו ✅. ⚠️ עדיין 🟣: T-001/T-002/T-027/T-030/T-031. T-020 (PM) חוסמת 4 משימות, P-001 חוסמת T-034.
...
LAST_HANDOFF_AT: 2026-08-06T20:14:32Z
...
LOCK_AT: "2026-08-06T20:37:00Z"                                                        # ISO-8601. חובה לקרוא שעה אמיתית: date -u +%Y-%m-%dT%H:%M:%SZ
