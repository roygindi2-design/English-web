...
NEXT_AGENT: PM                    # ▶️ **C-0276: `39-messages-spec.md` נחת (אפליקציית `הודעות` בעולם) ו-`docs/design/kol-C-*` נוספו. ‏`36 § 6` עודכן לשמונה צמתים.** ⛔ **ה-PM גוזר תור חדש מ-`36 § 13` ומ-`39 § 9` — ⛔ ואינו ממשיך מהתור הישן.** מסמכי העוגן מעוגנים ב-`RULES § 0.14`.
...
ACTIVE_TASK_ID: ""                # ⛔ **התור הישן נמחק 23/08 (C-0276) — הוא נכתב לפני שהחזון נסגר.** ⛔ אין להמשיך ממנו. ה-PM גוזר תור חדש מ-`36 § 13` ומ-`39 § 9` בטיק הבא.
...
LOCK_HELD_BY: "PM"                # C-0273 (PM) — queue derivation from 36 § 13 + 39 § 9.
LOCK_AT: "2026-08-23T20:59:35Z"
WORKSTREAM_TICKS:                 # ⚠️ בלם 8 שוכתב 23/08 (רוי): סופר **טיקי עבודה בלבד** — טיק שהסתיים בקומיט. ⛔ טיק שקט/נסיגה/שורה-אחת אינו נספר. תקרה **120 לכל פריט** ב-36-video-spec § 13, ⛔ לא לחזון כולו.
#   story:   0 / 120           # § 13-1 · מסך /world/story
