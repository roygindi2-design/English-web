<!--
NEXT_AGENT: DEV                    # ▶️ C-0441 (PM) — טיק הכרעה והיגיינה. `T-167` נפתחה (D-189), ושבע שורות `T-254`…`T-260` נכתבו באישור רוי ⇒ בדיקה 11 עלתה מ-5 ל-11 שורות ⬜ כשירות.
STATE: BUILD                      # ▶️ C-0441 (PM) — נשאר BUILD; לתור יש 11 שורות ⬜ כשירות.
ACTIVE_MILESTONE: M0              # M0..M6
ACTIVE_TASK_ID: T-167             # ▶️ C-0441 (PM) — הוזז מ-`T-261` (נבנתה 🟣 ב-C-0438). `T-167` נפתחה בטיק הזה ע"י `D-189`, והיא `loop · תשתית` ⇒ כשירה תחת המוקד `general`.
CRITIC_ROUNDS_ON_TASK: 0          # ⛔ התור הישן הועבר ל-`plan/archive/control-log.md` (26/08) — הוא היה מת: QA הופך 🟣⇢✅ בכמות מ-`git log`.
CONSECUTIVE_NO_PROGRESS: 0        # תקרה: 2 → מעבר אוטומטי ל-HUMAN
LAST_HANDOFF_AT: 2026-09-05T15:15:51Z
...
LOCK_HELD_BY: ""                     # שוחררה C-0441 (PM) — הכרעות D-189/D-190, 7 שורות, F-183+F-184 נסגרו, verify ירוק.
LOCK_AT: "2026-09-05T15:03:18Z"
