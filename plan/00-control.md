<!--
NEXT_AGENT: DEV                              # ▶️ C-0608 (PM): `general` — שתי ⬜ חדשות, `T-348`·`T-349`. `T-329` 🟣 (PM, STEP 5.5).
STATE: READY                      # ▶️ C-0608 (PM): `verify` ירוק, אין חוסם.
ACTIVE_MILESTONE: M0              # M0..M6
ACTIVE_TASK_ID: []   # ▶️ C-0529 — ריק.
CRITIC_ROUNDS_ON_TASK: 0          # ⛔ התור הישן הועבר ל-`plan/archive/control-log.md` (26/08) — הוא היה מת: QA הופך 🟣⇢✅ בכמות מ-`git log`.
LAST_HANDOFF_AT: "2026-09-14T13:59:47Z"   # C-0608 (PM, מלא) — הליכה, `T-329` נבנתה, `D-246`, שתי שורות חדשות.
HUMAN_DECISION_REQUIRED: false    # ▶️ ⛔ אינו ממתין. **44 · 45 · 46 נסגרו כולם ב-23/08.** נותר **47** — שורה ב-`RULES § 0.1 ב׳` שהיא הקובץ של רוי, ו⛔ **אינה חוסמת את הקידום של היום**.
# --- נעילה: מונעת שני סוכנים שכותבים לקובץ בו-זמנית ---
LOCK_HELD_BY: "DEV"              # 🔒 נלקחה 2026-09-14T14:32:20Z — C-0609 (DEV).
LOCK_AT: "2026-09-14T14:32:20Z"
...
#   general: — / 120          # ⛔ מחוץ לרצף `36 § 13` ⇒ ⛔ אין תקרה. ▶️ C-0605 (DEV): `T-347` 🟣 — **חריגה שנזרקת בדפדפן מפילה עכשיו את `check:mobile`**, בכל נתיב · רוחב · סכמה · מסע.
...
WORKSTREAM_ENDING: general · 2 ⬜ נותרו · 2026-09-14T13:59:47Z · C-0608   # ▶️ **C-0608 (PM): ⬜=0 נמדד בפתיחת הטיק — הפעם החמישית ב-36 שעות (`F-252`) — ושתי שורות נפתחו:** `T-348` (הגדר הכפולה במסך הסיכום, `D-246`·`F-253`) · `T-349` (הדרך החוצה מכשל חלקי — `top=783.5` על מסך 780, נמדד בהליכה של הטיק הזה). 🔴 **ויעד ה-RTL של `general` אכן גמור** — היעד החדש הוא «דרך אחת החוצה מכל כשל, ונצבעת» (`05-departments.md`).
