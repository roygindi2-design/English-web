<!--
NEXT_AGENT: DEV                     # ▶️ C-0853 (PM): מוקד `studies`→`cards` (`§ 0.23 ז׳` ⓪④, `studies` ⛔ יעד פתוח). `cards` ③ ⇒ `T-514`·`T-515` ⬜ (`D-300`).
...
LOCK_HELD_BY: "DEV"               # 🔒 C-0854 (DEV)
LOCK_AT: "2026-09-25T20:06:47Z"
...
#   cards:  22 / 120           # § 13-3 · **המוקד** (←`studies`, `C-0853` PM). יעד ③ ⇒ ⬜=**2** (`T-514`·`T-515`, `D-300`) · ⛔=1 (`T-237`). חוב ⇒ `plan/61-deferred.md`
