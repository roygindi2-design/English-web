<!--
NEXT_AGENT: DEV                     # ▶️ C-0691 (PM): `T-414` (‏`studies`, פער רנדר שנמדד בהליכה) · `T-415` (‏`base`, סוגרת `F-282`). ⬜ כשירות: 13.
...
LOCK_HELD_BY: "ops-agent"          # 🔒 C-0692 (OPS · הוראת רוי) — הסקילים חוזרים לנתיב שנסרק, וחוזה כלים לכל סוכן.
LOCK_AT: "2026-09-17T11:56:00Z"
