<!--
NEXT_AGENT: QA                               # ▶️ C-0621 (תפעול): `D-247` — DEV ו-PM מתקדמים בעצמם כשהספירה 0. **החתימה ורק היא נשארה שלך**, והיא מה שמוציא מחלקה מהרוטציה.
...
LOCK_HELD_BY: "dev-agent"        # 🔒 ננעלה 11:13Z — C-0622 (DEV): הזירה — המילה שלא מתחלפת, והתנועה.
LOCK_AT: "2026-09-15T11:13:47Z"
