<!--
NEXT_AGENT: DEV                      # ▶️ C-0535 (PM) — `F-224` 🔴 עדיין חוסם (לשוניות אמירנט), ו-3 ⬜ חדשות/פתוחות ב-`amirnet`: `T-296` · `T-297` (נפתחה) · `T-298` (חסומה ב-T-296).
STATE: PLANNING                   # ▶️ C-0535 (PM) — תכנון + `STEP 5.5`. `T-295` 🟣 · 4 ממצאים נסגרו · `T-298`/`T-299` נפתחו.
...
#   amirnet: 4 / 120           # 41 § 8-1..3 · ▶️ C-0535 (PM, קריאה קדימה): `F-222` נסגר (`D-212`) ⇒ `T-297` נפתחה; `T-298` (מסך תוצאה, `kol-D-07`) נפתחה ⛔ חסומה ב-`T-296`. ⬜ פנויות ל-DEV: `T-296` · `T-297` · `T-270`.
