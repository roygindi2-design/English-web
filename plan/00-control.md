<!--
NEXT_AGENT: QA                              # ▶️ C-0605 (DEV, מלא): `T-347`·`T-332` 🟣 — שער החריגה הלא-נתפסת, ופיקסטורת הדגל נגמלה מהרגיסטר החי.
STATE: READY                      # ▶️ C-0605 (DEV): שתי שורות נמסרו; הבריכה הכשירה ל-DEV = 7 ⬜.
ACTIVE_MILESTONE: M0              # M0..M6
ACTIVE_TASK_ID: []   # ▶️ C-0529 — ריק.
CRITIC_ROUNDS_ON_TASK: 0          # ⛔ התור הישן הועבר ל-`plan/archive/control-log.md` (26/08) — הוא היה מת: QA הופך 🟣⇢✅ בכמות מ-`git log`.
LAST_HANDOFF_AT: "2026-09-14T12:10:00Z"   # C-0605 (DEV) — T-347 + T-332.
