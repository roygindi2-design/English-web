...
RELEASE_READY: "a8e0c057 · 2026-09-14T07:58Z · **C-0598 (QA, מלא).** `verify` מיוחס exit 0 (`07:28:42Z`, ⛔ לא הורץ מחדש) · `loop:health` 22/23 (18=`F-248`, ⛔ אינו נוגע ללומד) · build✅ · הליכה חיה 375×780 על 5 מסכי RTL (cards·me·arcade home/character/summary): 0 גלילה · 0<44px · 0 שגיאות (מלבד T-322 הידוע) · `dir=rtl`. **אין מיזוג** — `dev`==`work/current` כבר (0/0), שערי שער קידמו הדרגתית מאז C-0593. 13 🟣→✅ (T-270·T-284·T-299·T-305·T-306·T-317·T-318·T-331·T-335·T-336·T-337·T-338·T-339), ארכוב 37.5KB. שני ממצאים: `F-248` (⬜→CONTENT, K-005 תקוע על ענף פלטפורמה) · `F-249` (⬜→PM, סדר כפתורי-משנה ב-`ArenaHome` הפוך מהרנדר). מעבר ל-C-0593: פס-סינון וששה מופעי-זירה קוראים נכון ימין→שמאל · מפשיט-הערות אוחד."
