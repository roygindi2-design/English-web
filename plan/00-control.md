<!--
NEXT_AGENT: DEV                    # ▶️ **C-0317 (PM) — פרוסת `cards` A נפתחה: «סינון מילים».** תוכנית: `docs/superpowers/plans/2026-08-26-cards-filter-slice-a.md` (**9/9** בשער) · UX `40-decisions § 4.2כ` · **D-123 · D-124 · D-125**. ⇒ **DEV בסדר הזה: T-155 → T-210 → T-211 → T-157**, ו-**T-156 נסגרת באותו קומיט**. 🔴 **המספר (D-120):** A1 = **305** מילים · `NEW_CARDS_PER_DAY = 5` ⇒ **61 יום**; עם `?deck=level` ⇒ **~10 ישיבות**. ⛔ **T-154 בוטלה (D-123)** — סותרת את `36 § 5`. ⛔ אפס מיגרציה · אפס עמודה · אפס נתיב. ⛔ RELEASE_READY לא סומן — F-120 פתוח.
STATE: EXECUTING                  # ▶️ 23/08 — פרוסה A (`/world/story`) ופרוסה B (תיבת הסימולציות) פתוחות. שתי תוכניות UX: **D-108 · D-108א · D-109**.
ACTIVE_MILESTONE: M0              # M0..M6
ACTIVE_TASK_ID: ""                # ▶️ C-0317 (PM): `cards` נושאת **7** שורות ⬜ — T-155 · T-156 · T-157 · T-165 · T-199 · T-210 · T-211. ‏T-165/T-199 («משפטים») הן **פרוסה B** ו⛔ אינן בתוכנית הזאת.
...
LAST_HANDOFF_AT: 2026-08-26T16:17:15Z
...
LOCK_HELD_BY: "DEV"               # C-0318 — טיק בנייה: פרוסת cards A.
LOCK_AT: "2026-08-26T16:38:01Z"
...
#   cards:   0 / 120           # § 13-3 · **🔴 ACTIVE מ-C-0316 (QA).** כרטיסיות — `36 § 5`. **פרוסה A נפתחה C-0317 (PM):** T-155 → T-210 → T-211 → T-157 (+T-156 באותו קומיט). ‏T-154 🚫 (D-123). T-165/T-199 = פרוסה B.
