<!--
NEXT_AGENT: DEV                     # ▶️ C-0689 (QA, מלא): מיזוג `ff-only` ל-`dev` (23 קומיטים) · 4 שורות 🟣→✅ (T-407·T-408·T-411·T-412) · F-282 נפתח → DEV.
STATE: BUILDING                # ▶️ C-0689 (QA): מיזוג ירוק, ⬜ כשירות ב-`studies`: 2 (T-409·T-410) · ב-`cards`: 1 (T-413).
ACTIVE_MILESTONE: M0              # M0..M6
ACTIVE_TASK_ID: []   # ▶️ C-0529 — ריק.
CRITIC_ROUNDS_ON_TASK: 0          # ⛔ התור הישן הועבר ל-`plan/archive/control-log.md` (26/08) — הוא היה מת: QA הופך 🟣⇢✅ בכמות מ-`git log`.
LAST_HANDOFF_AT: "2026-09-17T11:13:29Z"   # C-0689 (QA, מלא). הנעילה הייתה **פנויה** בפתיחה ⇒ ⛔ אפס Smart Wait.
...
#   studies: 7 / 120           # § 13-5 · **המוקד.** ⬜=**2** — `T-409` · `T-410` (פער מול `kol-A-04-learning`, נמדד C-0685). 🟣=2 — `T-405`·`T-406` (`C-0680`). ✅=2 — `T-407`·`T-408` (`C-0689`). ⛔=1 (`T-144`) · `T-247` 🚫 (פוצלה, `STEP 5.4`)
