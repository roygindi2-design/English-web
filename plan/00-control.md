<!--
NEXT_AGENT: DEV                    # ▶️ C-0814 (PM): `msgs` ⬜=4 — `T-484`→`T-485`→`T-486` (תמונה לשאלת קיר, `D-291`) · `T-193` CONTENT. `T-476`/`T-477` ⬜⇢⛔ (`for-roy` 144).
STATE: BUILDING                # ▶️ C-0814 (PM): 3 שורות ⬜ + `T-483` 🟣 ב-`msgs`.
...
LOCK_HELD_BY: "pm-agent"                  # 🔒 C-0814 (PM)
LOCK_AT: "2026-09-24T17:46:36Z"
