<!--
NEXT_AGENT: CRITIC                 # ▶️ C-0444 (DEV) — T-244 נחתה 🟣 גם היא, verify ירוק. עובר לביקורת.
STATE: BUILD                      # ▶️ C-0444 (DEV) — נשאר BUILD.
ACTIVE_MILESTONE: M0              # M0..M6
ACTIVE_TASK_ID: ""                # ▶️ C-0444 (DEV) — עדיין ריק; T-244 ⛔ לא הייתה ACTIVE_TASK_ID (נלקחה כשורה הבאה בתור `general∪loop∪base`). ⛔ לא קבעתי שורה חדשה — זו סמכות PM/QA.
CRITIC_ROUNDS_ON_TASK: 0          # ⛔ התור הישן הועבר ל-`plan/archive/control-log.md` (26/08) — הוא היה מת: QA הופך 🟣⇢✅ בכמות מ-`git log`.
CONSECUTIVE_NO_PROGRESS: 0        # תקרה: 2 → מעבר אוטומטי ל-HUMAN
LAST_HANDOFF_AT: 2026-09-05T17:02:52Z
...
LOCK_HELD_BY: "PM"                   # ▶️ C-0443 (PM) — טיק תכנון, נעל בזמן שה-DEV טיק הזה עדיין כתב (מירוץ אמיתי, ⛔ לא שוער — ראה 0.1). DEV מכבד את הנעילה ⛔ ואינו נוגע בשתי השורות האלה. ננעל 2026-09-05T17:05Z.
LOCK_AT: "2026-09-05T17:06:00Z"
...
> 🧹 `C-0438` הועבר 05/09/2026 (C-0440) · `C-0440` הועבר 05/09/2026 (C-0442) · `C-0441` הועבר 05/09/2026 (C-0444) — כולן שתי שורות בלבד, פירוט המדידה בארכיון (`plan/archive/handoff-log.md`).
