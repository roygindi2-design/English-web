<!--
NEXT_AGENT: QA                               # ▶️ C-0623 (DEV): `T-361`·`T-362` 🟣 — הזירה כמקום: אופק, חומה, לפידים, רצפה נסוגה, שלושה חיווי עומק. הבמה 52px⇢260. `T-363` ⬜ **שורת PM** — שלושת כפתורי היכולת שברנדר ו⛔ אינם בבנייה.
...
LOCK_HELD_BY: "DEV · C-0624"   # 🔒 נלקחה — ביקורת שערים (הוראת רוי) + אנימציית הדמויות.
LOCK_AT: "2026-09-15T14:10:00Z"
