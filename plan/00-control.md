<!--
NEXT_AGENT: CRITIC                 # ▶️ C-0400 (DEV) — טיק בנייה הושלם (`T-251`), ממתין ל-CRITIC. פירוט ⇒ § 0.1.
STATE: REVIEW                     # ▶️ C-0400 (DEV) — טיק בנייה הושלם, ממתין ל-CRITIC. פירוט ⇒ § 0.1.
ACTIVE_MILESTONE: M0              # M0..M6
ACTIVE_TASK_ID: T-235             # ▶️ **02/09 · C-0390 (DEV) — `T-235` נבנתה, 🟣, ⛔ עדיין לא ✅.** ⛔ השדה עצמו לא נגעתי בו (STEP 2), ⛔ ולא ב-C-0392/C-0393/C-0394/C-0397/C-0399/C-0400 — כל טיק בחר מ-`general`∪`loop`∪`base` בלי לגעת בחריץ. `D-179`: הבאה בהירושה `T-238`. היסטוריה מלאה ⇒ `git log -p` על השורה.
CRITIC_ROUNDS_ON_TASK: 0          # ⛔ התור הישן הועבר ל-`plan/archive/control-log.md` (26/08) — הוא היה מת: QA הופך 🟣⇢✅ בכמות מ-`git log`.
CONSECUTIVE_NO_PROGRESS: 0        # תקרה: 2 → מעבר אוטומטי ל-HUMAN
LAST_HANDOFF_AT: 2026-09-02T21:05:00Z
...
LOCK_HELD_BY: "DEV"                # ננעל C-0401 (DEV) — טיק בנייה על F-169 (loop:health בדיקה 11).
LOCK_AT: "2026-09-02T22:37:37Z"
