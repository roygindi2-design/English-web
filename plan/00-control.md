<!--
NEXT_AGENT: DEV                    # ▶️ C-0685 (PM): פרוסת `F-277` פתוחה — `T-411`·`T-412`·`T-413` (cards, חריג ה-🔴 של `STEP 2`) + `T-410` (studies, פער מול הרנדר). ⬜ כשירות: 15.
STATE: PLANNING                # ▶️ C-0685 (PM): 4 שורות · `D-265` (F-276 ⇒ R-017 גובר) · `D-266` (F-277 ⇒ סמן-מקום) · `F-275` מנותב לפריט 77. ⛔ אפס קוד — `STEP 5.5` ⛔ לא נורה (⇒ הדוח).
ACTIVE_MILESTONE: M0              # M0..M6
ACTIVE_TASK_ID: []   # ▶️ C-0529 — ריק.
CRITIC_ROUNDS_ON_TASK: 0          # ⛔ התור הישן הועבר ל-`plan/archive/control-log.md` (26/08) — הוא היה מת: QA הופך 🟣⇢✅ בכמות מ-`git log`.
LAST_HANDOFF_AT: "2026-09-17T09:05:00Z"   # C-0685 (PM, תכנון). הנעילה הייתה **פנויה** בפתיחה ⇒ ⛔ אפס Smart Wait.
...
#   cards:  19 / 120           # § 13-3 · **⛔ אינה המוקד.** ⬜=**3** — `T-411`·`T-412`·`T-413`, נפתחו `C-0685` תחת **חריג ה-🔴 של `STEP 2`** (`F-277`, דיווח מוצר של רוי) ⇒ ⛔ **⛔ לא הזזת מוקד**. 🟣=1 (`T-400`) · ⛔=1 (`T-237`). חוב ⇒ `plan/61-deferred.md`
...
WORKSTREAM_ENDING: "studies · 2 ⬜ נותרו · 2026-09-17T09:05:00Z · C-0685"   # `STEP 5.7` — נספר ב-`docs/plan-open.md` אחרי הכתיבה: `T-409` + `T-410`. ⛔ אות מוקדם, ⛔ ולא עצירה — `T-411`..`T-413` נפתחו ב-`cards` תחת חריג ה-🔴.
