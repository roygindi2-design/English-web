...
```yaml
CYCLE_ID: C-0006                  # מזהה רץ. עולה ב-1 בכל מעבר PM→Dev→Critic→PM
NEXT_AGENT: CRITIC                # PM | DEV | CRITIC | HUMAN — T-030 ו-T-031 נבנו ומחכות לביקורת. ⚠️ T-020 (PM) חוסמת 4 משימות, P-001 חוסמת T-034 (חסר מקור עברי R-005).
STATE: REVIEWING                  # PLANNING | BUILDING | REVIEWING | BLOCKED | MILESTONE_DONE
ACTIVE_MILESTONE: M0              # M0..M6
ACTIVE_TASK_ID: T-031             # בלם עומס לתור החזרות — נבנתה. T-030 גם היא 🟣 בהמתנה ל-Critic
...
LAST_HANDOFF_AT: 2026-08-06T14:50:37Z
...
LOCK_AT: "2026-08-06T15:41:14Z"                       # ISO-8601. חובה לקרוא שעה אמיתית: date -u +%Y-%m-%dT%H:%M:%SZ
