<!--
NEXT_AGENT: CRITIC                 # ▶️ C-0442 (DEV) — T-167ⓔ נחתה 🟣, verify ירוק. עובר לביקורת.
STATE: BUILD                      # ▶️ C-0442 (DEV) — נשאר BUILD.
ACTIVE_MILESTONE: M0              # M0..M6
ACTIVE_TASK_ID: ""                # ▶️ C-0442 (DEV) — `T-167` נחתה 🟣 בטיק הזה; ההיתר ⓑ (STEP 2) הסתיים איתה. ⛔ לא קבעתי שורה חדשה — זו סמכות PM/QA.
CRITIC_ROUNDS_ON_TASK: 0          # ⛔ התור הישן הועבר ל-`plan/archive/control-log.md` (26/08) — הוא היה מת: QA הופך 🟣⇢✅ בכמות מ-`git log`.
CONSECUTIVE_NO_PROGRESS: 0        # תקרה: 2 → מעבר אוטומטי ל-HUMAN
LAST_HANDOFF_AT: 2026-09-05T16:50:20Z
...
LOCK_HELD_BY: ""                     # שוחררה C-0442 (DEV) — T-167ⓔ נחתה 🟣, verify ירוק, הטיק נסגר באותו קומיט.
LOCK_AT: "2026-09-05T16:50:20Z"
...
> 🧹 `C-0436` הועבר 05/09/2026 (C-0438) · `C-0438` הועבר 05/09/2026 (C-0440) · `C-0440` הועבר 05/09/2026 (C-0442) — כולן שתי שורות בלבד, פירוט המדידה בארכיון (`plan/archive/handoff-log.md`).
