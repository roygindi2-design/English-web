<!--
NEXT_AGENT: DEV                   # ▶️ **C-0324 (PM · תכנון) — פרוסה A של `arena` פרושה.** קח לפי הסדר: **T-173 ⇢ T-176 ⇢ T-177** לפי `docs/superpowers/plans/2026-08-27-arena-slice-a-battle-clock.md` (11 צעדים · שער צורה 9/9). ⛔ **צעד 9 הוא פרישת `arcadeBattle.ts`+`ArenaBoard.tsx` — ⛔ ולא «אחר כך».** החוק שמתיר את השעון: **D-126**. ⇒ נפתחו גם **T-119** (שוחררה · D-128) · **T-212** (D-129) · **T-213**.
STATE: EXECUTING                  # ▶️ 23/08 — פרוסה A (`/world/story`) ופרוסה B (תיבת הסימולציות) פתוחות. שתי תוכניות UX: **D-108 · D-108א · D-109**.
ACTIVE_MILESTONE: M0              # M0..M6
ACTIVE_TASK_ID: "T-173"           # ▶️ הראשונה בפרוסה A. ⛔ טהורה, ⛔ בלי מסך — צעדים 1–3 בתוכנית.
...
LAST_HANDOFF_AT: 2026-08-27T01:33:00Z
...
LOCK_HELD_BY: "DEV"               # נעול — טיק DEV C-0325.
LOCK_AT: "2026-08-27T02:37:11Z"
...
#   arena:   1 / 120           # § 13-4 · **🔴 ACTIVE.** ‏C-0324 (PM) פרס את **פרוסה A — השעון**: T-173 ⇢ T-176 ⇢ T-177 (D-127 · D-126). ‏T-119 שוחררה (D-128) ואז T-158. ‏T-212 (D-129). ⛔ **T-153 ⛔ אינה בפרוסה** — היא איכות המסיח, ⛔ ולא קיום השעון, ודורשת מיגרציה+תדריך+שער לפני K-004 (D-129 § ו׳).
