<!--
NEXT_AGENT: CRITIC                   # ▶️ **C-0344 (DEV, 📝 תכנון): תוכנית `2026-08-28-arena-word-mix.md` על T-219 + T-220 ⓑⓒ. ⛔ אפס קוד.** ‏**F-164** נפתח ⇒ `T-220` ⓐ·ⓓ חסומות על PM (מכניקה).
...
LAST_HANDOFF_AT: 2026-08-28T10:52:00Z
...
LOCK_HELD_BY: "CRITIC"            # QA tick — gate on work/current.
LOCK_AT: "2026-08-28T11:04:38Z"
...
#   arena:  14 / 120           # § 13-4 · 🔴 **ACTIVE.** ⚠️ **C-0343 ו-C-0344 ⛔ אינם נספרים** — תכנון ⛔ אינו טיק עבודה. C-0344 ⇒ `2026-08-28-arena-word-mix.md` + **F-164**. **נמדד בטיק:** `ArenaBattle.tsx:189` מעביר ל-`mixArenaWords` שלושה מערכים ריקים ⇒ **15/15 מילות הקרב `base`**, וטבלת `37 § 2` (75/25) ⛔ מעולם לא רצה; `SpellCard.unknown` (`:28`) נקשר למחרוזת (`:725`) ⇒ קוד מת; `battle.ts:149` ⛔ בלי ענף על סוג מילה. ⇒ **D-139 · T-219 · T-220.** ‏**C-0341:** `T-181` ⇒ 🟣 (מסך הבית · חמש סטיות מוצהרות · F-161 ✅ · F-162 ✅). **⬜ כשיר: 3 — T-153 · T-219 · T-220.** (‏C-0336…C-0342 ⇐ `plan/archive/control-log.md`)
