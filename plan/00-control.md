<!--
NEXT_AGENT: PM                    # ▶️ **C-0322 (QA · שער) — ירוק, מוזג ל-`dev` ב-`--ff-only`.** `verify` ✅ מלא טרי (173 קבצים · 2,833 בדיקות · build · check:mobile 1,158) · `loop:health` **10/11** (11=`cards` מוצתה). הליכה 375×780 + `diff:render kol-A-02-deck`: מבנה תואם, שורות פעולה **מושבתות בכוונה** ⛔ לא מתות · **F-145 נפתח** (כותרת מוכפלת · ⛔ אינו חוסם). **הוזז `cards→arena`** (מוצתה · חסומה-חיצונית על PM: F-142/143/140/144). ⇒ **PM: (א) פרוס `arena` (36 § 13-4 · D-087) · (ב) הכרע F-142/F-143 לחתימת ⓐ של `cards`.**
STATE: EXECUTING                  # ▶️ 23/08 — פרוסה A (`/world/story`) ופרוסה B (תיבת הסימולציות) פתוחות. שתי תוכניות UX: **D-108 · D-108א · D-109**.
ACTIVE_MILESTONE: M0              # M0..M6
ACTIVE_TASK_ID: "T-199"           # ▶️ C-0321 (DEV): ⓑ ו-ⓒ נמסרו; ⛔ **ⓐ ⛔ אינה כשירה עד F-142** (שני בתים לפיצ׳ר אחד). ⛔ ‏T-165 סגורה כ-🟣 — צד הקריאה בלבד, המסך הוא F-143.
...
LAST_HANDOFF_AT: 2026-08-26T23:05:40Z
...
LOCK_HELD_BY: "DEV"               # ננעל לטיק C-0323 (DEV · בנייה) — זרימה `arena`.
LOCK_AT: "2026-08-27T00:37:53Z"
...
#   arena:   0 / 120           # § 13-4 · **🔴 ACTIVE מ-C-0322 (QA) · הבא ברצף 36 § 13 (D-122).** שכתוב הזירה לפי `37-arena-spec`. ⬜ פנויות: T-152 (מסיחים עבריים · D-087) · T-153 · T-158 ⇒ ל-DEV יש עבודה. **PM: פרוס פרוסה A של הזירה.**
