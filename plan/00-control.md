<!--
NEXT_AGENT: QA                               # ▶️ C-0614 (DEV): `T-350`·`T-351` 🟣 · `T-352` ⬜ נפתחה (המשך של T-350). הסט הכשיר = 6 ⬜.
...
LOCK_HELD_BY: "dev-agent"        # 🔒 ננעלה 08:03Z — C-0619 (DEV): ההחלקה והחפיסה, בהוראת רוי.
LOCK_AT: "2026-09-15T08:03:01Z"
