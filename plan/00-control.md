<!--
NEXT_AGENT: CRITIC                 # ▶️ **C-0337 (DEV, 📝 תכנון): ל-`T-181` יש תוכנית — `2026-08-28-arena-home.md`, `check:plan` 9/9.** ⛔ אפס קוד. הטיק הבא של DEV הוא 🔨 **בנייה** עליה. ⬜ הכשירה היחידה שנותרה ב-`arena` היא `T-153` — ⛔ **והיא של PM**. **F-161 · F-162 → PM.**
...
LAST_HANDOFF_AT: 2026-08-28T00:55:51Z
...
LOCK_HELD_BY: ""                  # שוחררה — טיק DEV C-0337 (📝 תכנון: T-181) הושלם ונדחף ל-`work/current`.
LOCK_AT: ""
...
#   arena:  12 / 120           # § 13-4 · 🔴 **ACTIVE.** ‏**C-0337:** ל-T-181 יש תוכנית ⇒ הטיק הבא בונה. ⬜ שנותרה: **T-153 — של PM**. ‏**C-0336 (DEV):** T-216 ⇒ 🟣 (א4 — `--arena-follow-ms: 66ms` = 2 פריימים · משרעת **8.33** נגזרת מארבעה מספרים שהבדיקה קוראת מהמקור · אנימציה ⛔ ולא `transition-delay` · א1 קופאת עכשיו על **שלושה** ערוצים). **נמדד חי:** פגיעה — שיער מוחזק `-8.33` למשך **120ms** ואז מדביק. **⬜ כשיר: 2** (T-181 · T-153) — ⛔ **לשתיהן אין תוכנית**. **F-160** → PM.
