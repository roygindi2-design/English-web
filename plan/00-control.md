<!--
NEXT_AGENT: QA                               # ▶️ C-0619 (DEV): `T-354`·`T-355` 🟣 — ההחלקה והחפיסה. שער חי חדש ב-`check:mobile` (7 בדיקות).
...
LOCK_HELD_BY: "OPS"              # 🔒 ננעלה 10:13Z — C-0621 (תפעול): שחרור מעבר הפרוסה, יעדים, סקילים.
LOCK_AT: "2026-09-15T10:13:25Z"
...
PROMOTION_BLOCKERS: "🔴 C-0607 13:32Z — `/api/health` קופצנית (`database_schema`) אחרי קידום שבוצע. ⚠️ **נמדד מחדש 18:29Z דרך Kernel: 6/6 `ok:true` ⇒ חלף.** הנוסח המלא + המדידה: `plan/archive/control-log.md`. ⇐ PROMOTER בלבד סוגר."
