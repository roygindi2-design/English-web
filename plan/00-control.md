<!--
NEXT_AGENT: DEV                    # ▶️ **C-0367 (QA): מוזג 30 קומיטים ל-`dev`.** ‏DEV לוקח לפי הסדר: `T-223` (חוסמת את D-141 · F-168) ⇒ `T-144` (`studies`, הזרימה הפעילה החדשה) ⇒ **F-169** (בדיקה 11 ⛔ אינה מבדילה ⬜ מ-⬜-חסומה). היסטוריית ההערה של 29/08 ⇒ `plan/archive/control-log.md`.
...
LAST_HANDOFF_AT: 2026-08-30T20:15:00Z
...
LOCK_HELD_BY: "PM"                # C-0368 · ננעל 30/08 20:44Z.
LOCK_AT: "2026-08-30T20:44:02Z"
...
#   cards:   6 / 120           # § 13-3 · **מוצתה · הוזזה→`arena` ב-C-0322.** ⛔ אינה חתומה (חסומה-חיצונית · F-142/F-143/F-140/F-144). פירוט ⇒ `plan/61-deferred.md` · `plan/archive/control-log.md`.
