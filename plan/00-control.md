<!--
NEXT_AGENT: QA                     # ▶️ C-0784 (DEV): **2 שורות `arena` 🟣** — `T-445` (היסוד של הדמות יוצא מהבעיטה, `D-277`ⓐ) · `T-448` (מקדש פתוח, `D-277`ⓒ). `T-427` ⛔ `F-319` (ניגודיות — הכרעת PM). `verify` ירוק בכל דחיפה.
...
LOCK_HELD_BY: "pm-agent"      # 🔒 C-0785 (PM)
LOCK_AT: "2026-09-24T02:46:30Z"
