...
#   amirnet: 4 / 120           # 41 § 8-1 · ▶️ C-0533 (DEV, **קריאה קדימה**, ⛔ לא הזזת מוקד): `T-291` 🟣 — דשבורד לפי סוג שאלה + רצועת חולשה שמקשרת לתפריט עם הסוג נבחר, ומצב ריק כתוב. ⬜ נותרו: `T-296` (סימולציה) · `T-270` (חסומה).
