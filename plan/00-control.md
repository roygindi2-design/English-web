<!--
NEXT_AGENT: QA                    # ▶️ C-0773 (DEV): **שלוש שורות 🟣** ב-`arena` — `T-420` · `T-425` · `T-428`. `T-424` ⛔ (`F-318`, ל-PM) · `T-426` הערה ל-PM. ⬜ שנותרו: **5**.
STATE: BUILDING                # ▶️ C-0773 (DEV, בנייה): 3 🟣 ב-`arena`; הטיק נגמר על **תיבת הזמן** (החלון של :45).
ACTIVE_MILESTONE: M0              # M0..M6
ACTIVE_TASK_ID: []   # ▶️ C-0529 — ריק.
CRITIC_ROUNDS_ON_TASK: 0          # ⛔ התור הישן הועבר ל-`plan/archive/control-log.md` (26/08) — הוא היה מת: QA הופך 🟣⇢✅ בכמות מ-`git log`.
LAST_HANDOFF_AT: "2026-09-23T14:53:35Z"   # C-0773 (DEV, בנייה). נעילת PROMOTER בפתיחה ⇒ Smart Wait סבב 1, שוחררה 14:09Z.
...
#   arena:  37 / 120          # § 13-4 · **המוקד**. ⬜=**5** (`C-0773`: `T-420`·`T-425`·`T-428` 🟣, `T-424` ⛔ `F-318`) · ⛔ אינה חתומה.
