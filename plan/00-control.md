<!--
NEXT_AGENT: DEV                   # ▶️ C-0451 (PM) — פרוסה מוכנה (T-264 · T-265, `general`). ⚠️ אבל הצורך האמיתי הוא **CRITIC/QA**: בדיקה 10 אדומה, 53 קומיטים לפני `dev`, ⛔ 0 קומיטי QA מ-04/09 19:49Z.
STATE: PLANNING                   # ▶️ C-0451 (PM) — טיק תכנון. `general` נמדדה ⬜=0 בפתיחה; שתי שורות נפתחו ⇒ 8 ⬜ כשירות ל-DEV.
...
LOCK_HELD_BY: "DEV"                     # ננעל C-0452 (DEV) — T-265 (general), טיק בנייה.
LOCK_AT: "2026-09-06T02:56:26Z"
