<!--
NEXT_AGENT: DEV                    # ▶️ **C-0316 (QA) — שער עבר, 16 קומיטים מוזגו ל-`dev` ב-`--ff-only` (פרוסת nav A + T-146).** `verify` ירוק · `loop:health` 10/11 (11 האדימה כי `nav` מוצתה — **תוקן: המוקד הוזז ל-`cards`**). 🟣→✅ הוהפכו: T-146·T-174·T-204·T-205·T-206. **`nav` נחתמה** (3 חותמות בבלוק SEALS, אימות מלא תלוי בהליכת רוי). ⇒ **DEV: קודם F-139** (הוסף `'cards'` ל-`WORKSTREAMS` ב-`planTable.ts` — חסרה מהקוד, ולכן 5 שורותיה «תג לא מוכר»), **ואז קח `cards`** (T-154·T-155·T-157·T-165·T-199). ⛔ RELEASE_READY לא סומן — F-120 (🔴 טוקן) פתוח עד סבב רוי. הישן ב-`archive/handoff-log.md`.
STATE: EXECUTING                  # ▶️ 23/08 — פרוסה A (`/world/story`) ופרוסה B (תיבת הסימולציות) פתוחות. שתי תוכניות UX: **D-108 · D-108א · D-109**.
ACTIVE_MILESTONE: M0              # M0..M6
ACTIVE_TASK_ID: ""                # ▶️ C-0316 (QA): המוקד `cards`. חמש שורות ⬜ ממתינות ל-DEV (T-154·T-155·T-157·T-165·T-199). ‏`arena` פריט 4 · `studies` פריט 5 · `msgs`/`base` ממתינות.
...
LAST_HANDOFF_AT: 2026-08-26T14:41:05Z
...
LOCK_HELD_BY: "PM"                # ננעל 2026-08-26T16:17Z — טיק תכנון PM על `cards`.
LOCK_AT: "2026-08-26T16:17:15Z"
...
#   cards:   0 / 120           # § 13-3 · **🔴 ACTIVE מ-C-0316 (QA).** כרטיסיות — `36 § 5`. חמש שורות ⬜ פעילות: T-154 · T-155 · T-157 · T-165 · T-199 (הוסטו מ-`base` ב-D-122). DEV לוקח מכאן.
#   arena:   0 / 120           # § 13-4 · שכתוב הזירה לפי 37-arena-spec
...
ACTIVE_WORKSTREAM: cards          # 🔴 ▶️ **C-0316 (QA): הוזז `nav`→`cards` — `nav` מוצתה (⬜=0), `cards` הבא ברצף 36 § 13 פריט 3 (D-122).** `cards` נושאת חמש שורות ⬜: T-154 · T-155 · T-157 · T-165 · T-199 (כולן `M1 · cards`) ⇒ ל-DEV יש עבודה כשירה. ⛔ ⛔ לא `arena` — ‏`arena` הוא פריט 4 (הרצף השתנה 26/08). QA קובע · PM מתכנן רק בה · תור DEV מסונן אליה.
