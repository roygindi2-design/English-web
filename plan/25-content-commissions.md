...
| K-003 | **מקלדת הבלוקים — עצי ההמשכים** (`39 § 3`) | ⛔ אין — נחסמה לפני שנכתב | ⛔ אין — **המודל נמדד ו⛔ אינו מצמצם** | 🔴 **F-117** · `scripts/measure-continuations.mjs` — סדר 1 פוסל **0.2%** מהבלוקים | ⛔ | **T-200** |

### ⛔ K-003 · נפתחה 23/08, **נחסמה חזרה 24/08 על סמך מדידה** — F-117
