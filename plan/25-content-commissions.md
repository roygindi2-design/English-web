...
| K-003 | **מקלדת הבלוקים — עצי ההמשכים** (`39 § 3`) | `docs/content-keyboard-brief.md` | `lib/core/continuationCoverage.ts` | ✅ **נפתחה 23/08 — המקור הוא בנק המשפטים שלנו** | ⬜ | **T-200** | — |

### ✅ K-003 · נפתחה 23/08 — הכרעת רוי + מדידה
